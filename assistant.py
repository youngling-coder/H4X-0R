    ...
    if h4x0r_settings.IS_ENABLED:
        ...
        if event.is_private and (not event.sender.bot):
            ...
            if not chat:
                ...
                chat = create_new_chat(title=event.chat_id, type_="private", participants={
            ...
            response = await respond_on_message(message=message, chat_name=event.chat_id, chat_object=chat)
